...
class nucleous {
    public:
        ...
        nucleous(std::string name_, double Z_, double R_, double a_, double rho0_)
            : name(name_), Z(Z_), R(R_), a(a_), rho0(rho0_) {}
};

extern nucleous Pb208; // parâmetros típicos para Pb-208: R=6.62 fm, a=0.546 fm, rho0=0.1603 fm^-3

extern nucleous proton; // parâmetros típicos para próton: R=0.84 fm, a=0.0 (sem diffusividade), rho0=0.17 fm^-3 (ajustado para A=1)
